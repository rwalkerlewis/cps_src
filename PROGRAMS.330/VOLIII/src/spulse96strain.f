...
c
c       02 MAR 2024 - Changed format statements for output file naming to match
c                  that given in the online help, e.g., (thanks to Wen Luo for pointing this out
...
c                   DDDDDddd_HHHhhh_ZZZzzz.cmp
   ...
   12               format(i8.8,'_',i6.6,'_',i6.6,'.',a3)
