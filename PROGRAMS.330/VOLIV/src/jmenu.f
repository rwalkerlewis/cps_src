...
c-----
        ...
        character*80 outl
        character outstr*12
        data outstr/'JOINT96 MENU'/
        data (out(i),i=1,10)/
     1 ' 0- Display menu                        '
     1,' 1- Run Dispersion                      '
     1,' 2- Run Velocity Inversion              '
     1,' 3- Run Q(beta) Inversion               '
     1,' 4- Run Simultaneous Veloc-Q Inversion  '
     ...
     1,'30- Fix layer (0)Vp,(1)Vp/Vs,(2)Brocher '
     1,'    Global fix (10)Vp, (11)Vp/Vs,       '
     1,'    (12)Brocher Vp,Rho from Vs          '
