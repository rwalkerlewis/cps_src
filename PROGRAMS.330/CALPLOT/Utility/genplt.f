...
c     05 JAN 2023 added -V vectorcommand
c     29 JAN 2023 changed one instance of sizey = 0.15 top sizey = 0.12 to agree with X-axis
c     02 FEB 2024 added some initializtion lines after the call pinitf()
c                 The problem was that one instance of ended with the
c                 color red and when several of these were cat'd
c                 the wrong colors were plotted
c-----
...
c-----
c     initialize because one may get bad results if once cat's
c     together several of these plots
c-----
      call gwidth(0.0)
      call newpen(1)
